#!/usr/bin/env python3
"""Export accepted hexapod episodes to a LeRobot-compatible dataset."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(description="Export hexapod episodes to LeRobot format")
...
def derive_repo_id(episodes_dir: Path, output_dir: Path, requested_repo_id: str) -> str:
    ...
    dataset_name = episodes_dir.parent.name or output_dir.parent.name or "hexapod"
