...
class RecordingConfig:
    ...
    # Dataset
    dataset_name: str = "hexapod_nav"
    repo_id: str = "<HF_DATASET_REPO>"
    robot_type: str = "hexapod"
...
class ExportConfig:
    ...
    episodes_dir: Path = field(default_factory=lambda: Path("data/hexapod_nav/episodes"))
    output_dir: Path = field(default_factory=lambda: Path("data/hexapod_nav/lerobot"))
    repo_id: str = "<HF_DATASET_REPO>"
    robot_type: str = "hexapod"
    fps: int = 10
